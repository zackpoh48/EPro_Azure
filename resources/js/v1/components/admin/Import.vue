                    ...
                    <form>
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    <label>Select</label>
                                    <select class="form-control" @change="setOption" v-bind:class="{
                                            'is-invalid': errors.option
                                        }">
                                        <option value="">Select</option>
                                        <option value="1">Create RFQ Applications</option>
                                        <option value="2">Update RFQ Applications</option>
                                        <option value="3">New Vendor Invitation</option>
                                        <option value="4">Update Password</option>
                                        <option value="5">Deactivate vendor from specific
                                            RFQ</option>
                                    </select>
                            ...
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control" id="customFile" @change="customFileChange" ref="import_file"
                        ...
                        <div class="row">
                            <div class="col-12 col-sm-6">
                                <p>
                                    ...
                                    <a :href="'storage/' + template" target="_blank">here</a>
                                </p>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-12 col-sm-6 text-left">
                                <button class="btn btn-primary" type="button" @click="runCron">
                                    Re-run CRON
                                </button>
                            </div>
                        </div>
