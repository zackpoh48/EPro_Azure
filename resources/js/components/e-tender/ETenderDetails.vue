                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb p-2 mb-1">
                        <li class="breadcrumb-item">
                            ...
                            <router-link to="/tenders">E-Tenders</router-link>
                        </li>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-4 col-sm-6 col-12">
                                Tender No. : <b>{{ form.rfq_id }} </b>
                            </div>
                            <div class="col-md-4 col-sm-6 col-12">
                                Date of Tender : <b>{{ form.date_of_rfq }}</b>
                            </div>
                            <div class="col-md-4 col-sm-6 col-12">
...
export default {
    ...
    return {
        ...
        form: {
            rfq_id: "TNDR-2024-003",
            date_of_rfq: "2026-03-01",
            priority: "High",
            quotation_no: "REQ-88921",
            buyer_remarks: "Please submit before closing date",

            //date_of_expiry: "2026-03-31",
            //delivery_date: "2026-04-05",
            //pay_terms: "30 days",
            //vendor_quotation_no: "VQ-2026-001",
            //quotation_valid_date: "2026-04-15",
            //supplier_remarks: "Delivery subject to stock availability",
            //delivery_location: "Kuala Lumpur Warehouse",
            //currency: "MYR",
            ...
            items: [
                {
                    id: 1,
                    item_no: "ITEM-001",
                    item_description: "Industrial Valve 2 inch",
                    qty: 10,
                    uom: "PCS",
                    item_expected_delivery: "2026-04-10",
                ...
                },
                {
                    id: 2,
                    item_no: "ITEM-002",
                    item_description: "Steel Pipe 3 meter",
                    qty: 20,
                    uom: "PCS",
                    item_expected_delivery: "2026-04-12",
        ...
        purchaseQuoteData: {
            needDate: "2026-04-05",
            //quotationValidDate: "2026-04-15",
            buyfromVendorNo: "VENDOR-001",
            no: "PQ-10012",
            documentDiscountPcnt: 5,
            currencyCode: "MYR",
        },

        finalDateDiff: "14 days",
        ...
        tnc_url: "terms-and-conditions.pdf",
    };
},
