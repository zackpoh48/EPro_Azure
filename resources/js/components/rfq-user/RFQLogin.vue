...
export default {
        ...
        return {
            ...
            formGroup: {
                ...
                rfq_id: {
                    ...
                    value: undefined,
                    rules(value: any) {
                        return [!!value || "RFQ ID is required"].filter(
    ...
    methods: {
        ...
        submitForm() {
            ...
            json = {
                ...
                rfq_id: this.formGroup.rfq_id.value,
                ...
                .then(
                    (res: {
                        ...
                        if (res.success) {
                            ...
                            localStorage.setItem("tnc_url", res.data.tnc_url);

                            this.$toast.success(res.message);
                            this.$router.push({
                                path: "/rfq/tender-list",
                            });
                        } else {
    ...
    mounted() {
        ...
        if (
            ...
            // this.$router.push("/rfq/tender-list");
        }
    },
};
</script>
