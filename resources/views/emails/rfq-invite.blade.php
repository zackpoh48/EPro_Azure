		...
		<thead style="background:#f8f9fa;margin:0px; padding:0px;">
			<tr style="margin:0px; padding:0px;">
				<th style="border:0px solid #eee;  margin:0px; padding:0px; width: 30%">
					<a href="{{url(env('APP_URL'))}}/rfq" style="display:inline-block">
					...
					<table style="margin:0px; padding:20px;">
						<!--	<tr style="margin:0px; padding:0px;">
							<td style="margin:0px; padding:0px;">
								<h6 style="font-size:16px; color:#6c757d;margin:0;font-family:'Roboto', sans serif;">
									Our Ref</h6>
							</td>
							...
							<td style="margin:0px; padding:0px;" colspan="4">
								<div style="width:100%">
									...
									<p style="color:#6c757d;margin:0 0 10px 0px;font-size:16px;">{{
											env('APP_COMPANY_NAME') }} would like to invite {{ $details->company_name }} to participate in the
									...
									<p style="color:#6c757d;margin:0 0 5px 0px;font-size:16px;">Login URL: <a href="{{ env('APP_URL') }}/rfq">{{ env('APP_URL') }}/rfq</a> </p>
									<p style="color:#6c757d;margin:0 0 5px 0px;font-size:16px;">Email: <span style="font-weight: bold;">{{ $details->email }}</span></p>
									<p style="color:#6c757d;margin:0 0 5px 0px;font-size:16px;">RFQ ID: <span style="font-weight: bold;">{{ $details->rfq_id }}</span></p>
									<p style="color:#6c757d;margin:0 0 20px 0px;font-size:16px;">Password: <span style="font-weight: bold;">{{ $details->password }}</span></p>
