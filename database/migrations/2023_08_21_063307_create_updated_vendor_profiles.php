...
return new class extends Migration {
    ...
    {
        Schema::create("updated_vendor_profiles", function (Blueprint $table) {
            $table->id();
            $table->foreignId("user_id");
            $table->string("name", 30);
            $table->string("email", 80);
            $table->string("registered_email_address", 80);
            $table->string("vendor_no");
            $table->string("company_name", 50);
            $table->string("company_reg_no", 20);
    ...
    {
        Schema::dropIfExists("updated_vendor_profiles");
    }
};
